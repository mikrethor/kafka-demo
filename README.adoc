...
This docker-compose.yml can be foiund on https://github.com/confluentinc/cp-all-in-one/blob/7.1.2-post/cp-all-in-one-community/docker-compose.yml[Confluent Github]
...
And voilà, you should see something sinilar to :
